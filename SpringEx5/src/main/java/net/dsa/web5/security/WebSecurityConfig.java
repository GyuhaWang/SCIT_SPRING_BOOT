...
import net.dsa.web5.SpringEx5Application;
...
public class WebSecurityConfig {
    ...
    private final SpringEx5Application springEx5Application;
    ...
    WebSecurityConfig(SpringEx5Application springEx5Application) {
        this.springEx5Application = springEx5Application;
    }
    ...
    protected SecurityFilterChain config(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(author -> author
                ...
                .requestMatchers("/admin/**").hasRole("ADMIN") // /admin/ 경로로 들어오는 모든 요청은 ADMIN_USER 권한 일 때만 접근 가능
...
//        		.accessDeniedPage("/error/403")
        		.accessDeniedHandler((request,response,accessDeniedException)->{
        				response.sendRedirect("/web/error/403");})
